...
### [v#{ENV['PRODUCT_VERSION']}](https://github.com/realityforge/gwt-symbolmap/tree/v#{ENV['PRODUCT_VERSION']}) (#{ENV['RELEASE_DATE']})
[Full Changelog](https://github.com/realityforge/gwt-symbolmap/compare/v#{ENV['PREVIOUS_PRODUCT_VERSION']}...v#{ENV['PRODUCT_VERSION']})
HEADER
